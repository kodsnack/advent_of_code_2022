...
def solve(lines):
    ...
    total, demand, used = 70000000, 30000000, stack[0].tell_size()
    unused = total - used
    needed = demand - unused
    return min(map(lambda i: i[1] if i[1] >= needed else 70000000, stack[0].traverse_tree()))
